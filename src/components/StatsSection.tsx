  ...
  return (
    <>
      <section className="bg-[#f9f9f9] py-24 flex flex-wrap w-[100%] px-5 lg:px-0">
        ...
        {/* ICONS SECTION */}
        <div className="mt-4 grid grid-cols-2 gap-5 lg:grid-cols-5  sm:grid-cols-3 lg:gap-8 max-w-5xl xl:max-w-6xl xxl:max-w-7xl mx-auto">
          {/* 1 */}
          <div data-aos="fade-right" className="box relative group flex flex-col items-center justify-center"
          >
            ...
            <h6 className="font-semibold sm:text-lg text-sm mt-2">Near To Subway</h6>
          ...
          {/* 2 */}
          <div  data-aos="fade-up" className="box relative group flex flex-col items-center justify-center mt-0 lg:mt-28">
            <div className="absolute mb-20 bg-[#EBCFA7] rounded-full opacity-60 size-16 group-hover:block hidden "></div>
            <Image
              width={65}
              height={65}
          ...
          {/* 3 */}
          <div  data-aos="fade-up" className="box relative group flex flex-col items-center justify-center">
            <div className="absolute mb-20 bg-[#EBCFA7] rounded-full opacity-60 size-16 group-hover:block hidden "></div>
            <Image
              width={65}
              height={65}
            ...
            />
            <h6 className="font-semibold sm:text-lg text-sm mt-2">Spaces in Pozniaky</h6>
            <div className="flex items-end gap-1 mt-2">
          ...
          <div  data-aos="fade-up" className="box relative group flex flex-col items-center justify-center mt-0 lg:mt-28">
            ...
            <h6 className="font-semibold sm:text-lg text-sm mt-2">Spaces in Pozniaky</h6>
            <div className="flex items-end gap-1 mt-2">
              <span className="sm:font-extrabold font-semibold text-[50px] leading-none">  <CountUp enableScrollSpy={true} duration={2} end={3} /></span>{" "}
              <h6 className="font-semibold">years</h6>
            </div>
          </div>
          {/* 5 */}
          <div  data-aos="fade-left" className="box relative group flex flex-col items-center justify-center">
            <div className="absolute mb-20 bg-[#EBCFA7] rounded-full opacity-60 size-16 group-hover:block hidden "></div>
            <Image
              width={65}
              height={65}
