          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            <div className="space-y-2">
              <Image
                ...
                className=" h-[11rem] w-[11rem] sm:h-[13rem] object-cover sm:w-[18.6rem] rounded"
            ...
            <div className="space-y-2">
              <Image
                ...
                height={600}
                alt="Image Description"
                className="h-[11rem] w-[11rem] sm:h-[22rem] object-cover sm:w-[18.6rem] rounded"
              ...
              <Image
                ...
                height={600}
                alt="Image Description"
                className="h-[11rem] w-[11rem] sm:h-[33rem] object-cover sm:w-[18.6rem] rounded"
